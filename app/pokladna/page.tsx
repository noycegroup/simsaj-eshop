...
export default function CheckoutPage() {
  ...
  else if (confirmed) content = <main className="flow-page"><div className="checkout-success"><span>✓</span><h1>Skúšobný tok je dokončený</h1><p>Žiadna objednávka nebola odoslaná a platba neprebehla. Formulár nám potvrdil, že prechod od produktu po pokladňu funguje.</p><Link className="button primary" href="/produkty">Späť na produkty</Link></div></main>;
