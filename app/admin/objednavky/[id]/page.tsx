...
type Order = { id: string; order_number: string; email: string; status: string; payment_status: string; payment_method: string; grand_total: number; subtotal: number; shipping_total: number; discount_total: number; tax_total: number; currency: string; created_at: string; placed_at: string | null; is_test: boolean; shipping_method: string; shipping_carrier: string | null; tracking_number: string | null; shipped_at: string | null; shipping_address: Json; billing_address: Json; customer_note: string | null; order_items: Item[] };
